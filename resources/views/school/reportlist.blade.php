            ...
            <main class="flex-1 overflow-y-auto">
                <div class="mb-6">
                    ...
                    <x-breadcrumb :items="[
                        ...
                        'School Report List' => null
                    ]" />
                </div>

                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100"></h2>
                    <p class="text-gray-600 dark:text-gray-300">Select Reports Schools
                    </p>
                </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                <tr class="border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <td class="py-3 px-4 text-gray-700 dark:text-gray-300">School Full Report</td>
                                    <td class="py-3 px-4">
                                    ...
                                    <td class="py-3 px-4">
                                        <a href="{{ route('school.fullreport') }}" class="text-blue-500 dark:text-blue-400 hover:underline">View</a>
                                    </td>
                                </tr>
                                {{-- <tr class="border-b border-gray-200 dark:border-gray-700">
