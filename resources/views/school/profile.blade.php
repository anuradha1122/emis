                        ...
                        <div class="md:flex">
                            ...
                            <div class="md:w-3/4 p-6">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ $school->name }}
                                        </h1>
                                    </div>
                                ...
                                <div class="mt-4 space-y-3">
                                    @php
                                        // Combine address lines into one clean string
                                        $fullAddress = collect([
                                            $school->contactInfo->addressLine1 ?? null,
                                            $school->contactInfo->addressLine2 ?? null,
                                            $school->contactInfo->addressLine3 ?? null,
                                        ])->filter()->join(', ');

                                        $schoolDetails = [
                                            ['icon' => 'hash', 'label' => 'Census No', 'value' => $school->censusNo ?? 'N/A'],
                                            ['icon' => 'map-pin', 'label' => 'Address', 'value' => $fullAddress ?? 'N/A'],
                                            ['icon' => 'phone-call', 'label' => 'Contact Number', 'value' => $school->contactInfo->mobile1 ?? 'N/A'],
                                            ['icon' => 'globe', 'label' => 'Authority', 'value' => $school->school->authority->name ?? 'N/A'],
                                            ['icon' => 'book-open', 'label' => 'Class Type', 'value' => $school->school->classType->name ?? 'N/A'],
                                            ['icon' => 'users', 'label' => 'Gender Type', 'value' => $school->school->gender->name ?? 'N/A'],
                                            ['icon' => 'languages', 'label' => 'Medium', 'value' => $school->school->language->name ?? 'N/A'],
                                            ['icon' => 'map', 'label' => 'Density', 'value' => $school->school->density->name ?? 'N/A'],
                                            ['icon' => 'building', 'label' => 'Facility', 'value' => $school->school->facility->name ?? 'N/A'],
                                            ['icon' => 'users', 'label' => 'Ethnicity', 'value' => $school->school->ethnicity->name ?? 'N/A'],
                                            ['icon' => 'cross', 'label' => 'Main Religion', 'value' => $school->school->religion->name ?? 'N/A'],
                                            ['icon' => 'briefcase', 'label' => 'Education Office', 'value' => $school->school->office->workPlace->name ?? 'N/A'],
                                        ];
                                    @endphp
