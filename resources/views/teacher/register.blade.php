                ...
                <div class="mt-8 border-t border-gray-200 dark:border-gray-700">
                    <form method="POST" action="{{ route('teacher.register') }}" class="mx-auto mt-8 max-w-xl sm:mt-8" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-6">
                            ...
                            <x-form-list-input-section size="sm:col-span-3" name="subject" id="subject" :options="$subjects" selected="" label="Appointment Subject"/>
                            ...
                            <x-form-list-input-section size="sm:col-span-3" name="medium" id="medium" :options="$appointedMediums" selected="" label="Appointment Medium" />
                            <x-form-list-input-section size="sm:col-span-3" name="category" id="category" :options="$appointmentCategories" selected="" label="Appointment category" />
                            <x-form-date-input-section size="sm:col-span-3" name="birthDay" id="birthDay" label="Birth Day" value="{{ old('birthDay') }}" />
                            <x-form-list-input-section size="sm:col-span-3" name="ranks" id="ranks" :options="$ranks" selected="" label="Service Appointment Rank" />
