        ...
        <div class="bg-white w-full shadow-sm border border-gray-200 rounded-lg p-1">
            <ul class="space-y-1">
                ...
                <li class="p-2 rounded-md bg-gray-100 duration-300 flex items-center gap-2">
                    ...
                    <a href="{{ route('teacher.profile', ['id' => $teacher->usId ]) }}" class=" w-full">
                        <div>
                            <span class="font-medium block">{{ $teacher->name }}</span>
                            <span class="text-gray-600 text-sm">{{ $teacher->nic }}</span>
                        </div>
                    </a>
                </li>
                @endforeach
