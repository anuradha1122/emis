<div>
    ...
    <form wire:submit.prevent="exportExcel" enctype="multipart/form-data">
        ...
        <div class="flex items-center justify-start gap-2 mx-4">
            ...
            <a href="{{ route('principal.transferreport') }}" class="mt-4 p-2 transition duration-200 bg-white hover:bg-white focus:bg-white
            ...
            <div class="p-1.5 min-w-full inline-block align-middle">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">{{ $result->userService->user->currentPrincipalService?->currentAppointment?->workPlace?->name }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">{{ $result->userService->user->currentPrincipalService?->appointedDate }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">{{ $result->userService->user->currentPrincipalService?->currentAppointment?->appointedDate }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
