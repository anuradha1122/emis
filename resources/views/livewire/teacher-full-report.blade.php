            ...
            <div class="p-1.5 min-w-full inline-block align-middle">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">{{ $result->currentTeacherService?->currentAppointment?->workPlace?->name }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">{{ $result->currentTeacherService?->appointedDate }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-white">{{ $result->currentTeacherService?->currentAppointment?->appointedDate }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
