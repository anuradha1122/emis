            ...
            <main class="flex-1 overflow-y-auto">
                <div class="mb-6">
                    ...
                    <x-breadcrumb :items="[
                        ...
                        'Principal Transfer Report' => null
                    ]" />
                </div>

                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100"></h2>
                    <p class="text-gray-600 dark:text-gray-300">Transfer Report SLPS(Sri Lanka Principal Service)
                    </p>
                </div>

                <!-- Reports Table -->
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow mb-6">
                    @livewire('principalTransferReport')
                </div>
            </main>
        </div>
    </div>
