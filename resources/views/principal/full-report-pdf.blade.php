            ...
            <main class="flex-1 overflow-y-auto">
                <div class="mb-6">
                    ...
                    <x-breadcrumb :items="[
                        ...
                        'Principal Full Report PDF' => null
                    ]" />
                </div>

                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100"></h2>
                    <p class="text-gray-600 dark:text-gray-300">Full Report PDF SLTP(Sri Lanka Principal Service)
                    </p>
                </div>

                <!-- Reports Table -->
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow mb-6">
                    <form action="{{ route('principal.exportfullreportpdf') }}" method="POST" enctype="multipart/form-data" target="_blank">
                        @csrf
                        ...
                        <div class="flex items-center justify-start gap-2 mx-4">
                            ...
                            <a href="{{ route('principal.fullreportPDF') }}" class="mt-4 p-2 transition duration-200 bg-white hover:bg-white focus:bg-white
