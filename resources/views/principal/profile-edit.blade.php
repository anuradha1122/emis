            ...
            <main class="flex-1 overflow-y-auto">
                <div class="mb-6">
                    ...
                    <x-breadcrumb :items="[
                        ...
                        'Principal Profile' => route('principal.profile', ['id' => $encryptedId]),
                        'Edit' => null
                    ]" />
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">Manage View SLPS(Sri Lanka Principal Service)
                    </p>
                </div>
                @if (session('success'))
                ...
                <div class="mt-8 border-t border-gray-200 dark:border-gray-700">
                    @if($section === 'personal')
                    <form method="POST" action="{{ route('principal.profileupdate') }}">
                        @csrf
                        ...
                        {{-- Full Name, Email, NIC (users table) --}}
                            ...
                            id="email"
                            label="Email"
                            value="{{ old('email', $principal->email) }}" />
                            ...
                            label="Date of Birth"
                            type="date"
                            value="{{ old('birthDay', optional($principal->personalInfo)->birthDay) }}" />
                            ...
                            value="{{ old('perm_address1', optional($principal->contactInfo)->permAddressLine1) }}" />
                            <x-form-text-input-section
                            size="sm:col-span-2"
                            name="perm_address2"
                            id="perm_address2"
                            label="Permanent Address Line 2"
                            value="{{ old('perm_address2', optional($principal->contactInfo)->permAddressLine2) }}" />
                            <x-form-text-input-section
                            size="sm:col-span-2"
                            name="perm_address3"
                            id="perm_address3"
                            label="Permanent Address Line 3"
                            value="{{ old('perm_address3', optional($principal->contactInfo)->permAddressLine3) }}" />
                            ...
                            value="{{ old('res_address1', optional($principal->contactInfo)->tempAddressLine1) }}" />
                            <x-form-text-input-section
                            size="sm:col-span-2"
                            name="res_address2"
                            id="res_address2"
                            label="Residential Address Line 2"
                            value="{{ old('res_address2', optional($principal->contactInfo)->tempAddressLine2) }}" />
                            <x-form-text-input-section
                            size="sm:col-span-2"
                            name="res_address3"
                            id="res_address3"
                            label="Residential Address Line 3"
                            value="{{ old('res_address3', optional($principal->contactInfo)->tempAddressLine3) }}" />
                            ...
                            id="mobile1"
                            label="Mobile 1"
                            value="{{ old('mobile1', optional($principal->contactInfo)->mobile1) }}" />
                            <x-form-text-input-section
                            size="sm:col-span-3"
                            name="mobile2"
                            id="mobile2"
                            label="Mobile 2 / WhatsApp"
                            value="{{ old('mobile2', optional($principal->contactInfo)->mobile2) }}" />
                    ...
                    <form method="POST" action="{{ route('principal.profileupdate') }}">
                        ...
                        <div class="grid sm:grid-cols-3 gap-6">
                            ...
                            <x-form-list-input-section
                                ...
                                :options="$races"
                                label="Race"
                                :selected="old('race', optional($principal->personalInfo)->raceId)" />
                            ...
                            <x-form-list-input-section
                                ...
                                :options="$religions"
                                label="Religion"
                                :selected="old('religion', optional($principal->personalInfo)->religionId)" />
                            ...
                            <x-form-list-input-section
                                ...
                                label="Civil Status"
                                :selected="old('civilStatus', optional($principal->personalInfo)->civilStatusId)" />
                            ...
                            <x-form-list-input-section
                                ...
                                :options="$genders"
                                label="Gender"
                                :selected="old('gender', optional($principal->personalInfo)->genderId)" />
                    ...
                    <form action="{{ route('principal.profileupdate', ['id' => $encryptedId]) }}" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{ $decryptedId }}">
                    ...
                    @if($section === 'education-info')
                        ...
                        <table class="mt-4 w-1/2 border border-gray-300">
                            ...
                            <tbody>
                                @foreach($principal->educationQualificationInfos->where('active', 1) as $edu)
                                    <tr class="text-sm font-medium text-gray-700 dark:text-white">
                    ...
                    <table class="mt-4 w-1/2 border border-gray-300">
                        ...
                        <tbody>
                            @foreach($principal->professionalQualificationInfos->where('active', 1) as $prof)
                                <tr class="text-sm font-medium text-gray-700 dark:text-white">
                    ...
                    <form action="{{ route('principal.profileupdate', ['id' => $encryptedId]) }}" method="POST">
                        ...
                        <div class="grid sm:grid-cols-3 gap-4 mt-4">
                            ...
                            <span class="sm:col-span-2" >@livewire('form-user-area-school-list');</span>
                        ...
                        <x-form-button-primary size="" text="Add Appointment" modelBinding="" />
                    </form>
                    @endif
