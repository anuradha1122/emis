    ...
    <div class="relative max-w-7xl mx-auto px-6 py-16 sm:py-20 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
            ...
            <div class="group">
                <div class="flex items-center space-x-2 mb-6">
                    <div class="w-12 h-12 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-lg flex items-center justify-center transform group-hover:rotate-12 transition duration-500">
                        <img class="h-12 w-auto bg-white rounded-full" src="{{ asset('images/log.png') }}"
                            alt="Logo">
                    </div>
                    <div>
                        <div>
                            <p class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">
                                EMIS
                            </p>
                        </div>
                        <div>
                            <span class="text-xs">Education Platform</span>
                        </div>
                ...
                <p class="text-gray-400 text-sm mb-6">
                    The award-winning Education Management Information System serving the
                    Sabaragamuwa Province, enhancing learning through efficient data management.
                </p>
            ...
            <div>
                <h3 class="text-lg font-semibold mb-6 relative inline-block">
                    ...
                    <span
                        class="absolute bottom-0 left-0 w-full h-1 bg-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300"></span>
                </h3>
                <ul class="space-y-3">
                    <li>
                        <a href="#"
                            ...
                            <span
                                class="w-1 h-1 bg-blue-500 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition duration-300"></span>
                            Home
                        </a>
                    </li>
                    <li>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                            <div
                                ...
                                <svg class="w-4 h-4 text-blue-400" xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <li class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="mailto:info@semis.lk"
                                class="text-white hover:text-blue-400 transition">info@emis.lk</a>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="flex-shrink-0 mt-1">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="tel:+94452222184" class="text-white hover:text-blue-400 transition">+94 45 2222
                                184</a>
                        </div>
                    </li>
                </ul>
        ...
        <div class="mt-16 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm mb-4 md:mb-0">
                &copy; <span id="year" class="text-blue-400"></span> Ministry of Education. All rights reserved.
            </p>
